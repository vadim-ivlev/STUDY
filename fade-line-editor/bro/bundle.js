...
require('./fadeline-jquery.js');

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } // import '../node_modules/jquery/dist/jquery.min.js'
...
console.log('\n\u042D\u0442\u043E \u043D\u043E\u0432\u0430\u044F\n\u0441\u0442\u0440\u043E\u043A\u0430 3.');
},{"./fadeline-jquery.js":2}],2:[function(require,module,exports){
'use strict';
